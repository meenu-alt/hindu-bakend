                     ...
                     <div class="col-xs-4">
                        <div class="inbox-avatar">
                           ...
                           <div class="inbox-avatar-text hidden-xs hidden-sm">
                              <div class="avatar-name">Edit Term of use</div>
                              <div><small>Term of use</small></div>
                           </div>
                        </div>
                     </div>
                     <div class="col-xs-8">
               ...
               <div class="mailbox-body">
                  <div class="row m-0">
                     <div class="col-xs-12 col-sm-12 col-md-12 p-0 inbox-mail p-20">
                        <?php if (isset($term_of_use)){ ?>
                           <?php foreach ($term_of_use as $key => $term_of_use_value) { ?>
                              <form action="<?=base_url('admin_controller/add_tou/').$term_of_use_value['term_of_use_id']?>" method="post" enctype="multipart/form-data">
                                 <!-- summernote -->
                                 <textarea id="summernote" name="term_of_use_desc"><?=$term_of_use_value['term_of_use_desc']?></textarea>
                                 <div class="btn-group pull-right">
                                    <button type="submit" class="btn btn-add">UPDATE TOU</button>
                                 </div>
                              </form>
                           <?php } ?>                           
                        <?php } else { ?>
