            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="tb_search">
                  ...
                  <a href="<?=base_url('admin_controller/add_blog/')?>">
                  <!-- <button type="button" class="btn btn-add btn-sm">Add New Blog</button> -->
              	  </a>
                </div>
              </div>
            </div>
        ...
        <div class="table-responsive">
          <table id="table-id" class="table table-bordered table-class table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td><?=$key+1?></td>
                <td><?=$term_of_use_value['term_of_use_name']?></td>
                <td style="white-space: nowrap;">
                  <a href="<?=base_url('admin_controller/add_term_of_use/').$term_of_use_value['term_of_use_id']?>">
