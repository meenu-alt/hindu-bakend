                     ...
                     <div class="col-xs-4">
                        <div class="inbox-avatar">
                           ...
                           <div class="inbox-avatar-text hidden-xs hidden-sm">
                              <div class="avatar-name">Add / Edit Page</div>
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-12 p-0 inbox-mail p-20">
                        <?php if (isset($blog)){ ?>
                           <?php foreach ($blog as $key => $blog_value) { ?>
                              <form action="<?=base_url('admin_controller/add_pages/').$blog_value['id']?>" method="post" enctype="multipart/form-data">
                                 <div class="form-group row">
                                    <label class="col-sm-3 col-md-3 col-form-label text-right">Page Title :</label>
                                    <div class="col-sm-9 col-md-9">
                                       <input class="form-control" type="text" value="<?=$blog_value['name']?>" name="blog_name"  id="product_name">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-5 col-md-5">
                                       <?php if (empty($blog_value['img'])) { ?>
                                          <img src="" width="300px" height="250px" id="userImg" style="display: none;">
                                       <?php } else {?>
                                          <img src="<?=base_url().$blog_value['img']?>" width="300px" height="250px" id="userImg">
                                       <?php } ?>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label class="col-sm-3 col-md-3 col-form-label text-right">Page Keywords :</label>
                                    <div class="col-sm-9 col-md-9">
                                       <input class="form-control" type="text" value="<?=$blog_value['keyword']?>" name="blog_keyword"  id="blog_keyword">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label class="col-sm-3 col-md-3 col-form-label text-right">Page Descreption :</label>
                                    <div class="col-sm-9 col-md-9">
                                       <!-- <input class="form-control" type="text" value="" name="blog_name"  id="product_name"> -->
                                    <textarea class="form-control" name="blog_description"><?=$blog_value['description']?></textarea>
                                    </div>
                                 </div>
                                 <!-- <div class="form-group row">
                                    <label class="col-sm-3 col-md-3 col-form-label text-right">Blog URL :</label>
                                    <div class="col-sm-9 col-md-9">
                                       <input class="form-control" type="text" value="<?=$blog_value['url']?>" name="blog_url"  id="blog_url">
                                    </div>
                                 </div> -->
                                 <!-- summernote -->
                                 <textarea id="summernote" name="blog_desc"><?=$blog_value['desc']?></textarea>
                                 <div class="btn-group pull-right">
                                    <button type="submit" class="btn btn-add">UPDATE Page</button>
                                 </div>
                              </form>
                           <?php } ?>                           
                        <?php } else { ?>
                           <form action="<?=base_url('admin_controller/add_pages')?>" method="post" enctype="multipart/form-data">
                              <div class="form-group row">
                                 <label class="col-sm-3 col-md-3 col-form-label text-right">Page Title :</label>
                                 <div class="col-sm-9 col-md-9">
                              ...
                              <?php /*
                              <div class="form-group row">
                                 <label class="col-sm-3 col-md-3 col-form-label text-right">Page URL :</label>
                                 <div class="col-sm-9 col-md-9">
                              ...
                              */ ?>
                              ...
                              <div class="btn-group pull-right">
                                 <button type="submit" class="btn btn-add">ADD Page</button>
                              </div>
                           </form>
                        <?php } ?>
                     </div>
