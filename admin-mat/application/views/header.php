...
<head>
      ...
      <!-- Bootstrap rtl -->
      <!--<link href="<?=base_url()?>/assets/bootstrap-rtl/bootstrap-rtl.min.css" rel="stylesheet" type="text/css"/>-->
      <!-- Lobipanel css -->
      ...
      <!-- toast style -->
      <link rel="stylesheet" href="<?=base_url()?>assets/dist/css/jquery.toast.css">
      <!-- toast style -->
      <!-- Theme style -->
   ...
   <body class="hold-transition sidebar-mini">
      ...
      <div class="wrapper">
         <header class="main-header">
            <a href="<?=base_url('admin_controller/dashboard')?>" class="logo">
               <!-- Logo -->
               <span class="logo-mini">
               <!-- <img src="<?=base_url()?>/assets/dist/img/mini-logo.png" alt=""> -->
               <h2 style="color: #fff;">HH-ADMIN</h2>
               </span>
               <span class="logo-lg">
                     ...
                     <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu" >
                           <li>
                              ...
                              <i class="fa fa-user"></i> <?php if (!isset($_SESSION['name'])){ ?>User Profile<?php } else { echo $_SESSION['name']; } ?>
                              </a>
                           </li>
                           <!-- <li><a href="#"><i class="fa fa-inbox"></i> Inbox</a></li> -->
                           <li><a href="<?=base_url('admin_controller/logout')?>">
         ...
         <aside class="main-sidebar">
            ...
            <div class="sidebar">
               ...
               <ul class="sidebar-menu">
                  <?php foreach ($get_admin_menu as $key => $getAdminMenuValue) { ?>
                     <?php if ( in_array($getAdminMenuValue['am_id'], $_SESSION['privilege']) || empty($_SESSION['privilege']) ){ ?>
                     <?php if ($getAdminMenuValue['am_sub_status'] == 0){ ?>                        
                        <li class="active">
                           <a href="<?=base_url('/').$getAdminMenuValue['am_link']?>"><i class="<?=$getAdminMenuValue['am_icon']?>"></i><span><?=$getAdminMenuValue['am_name']?></span>
                     ...
                     <?php } else{ ?>
                        ...
                        <li class="treeview">
                           <a href="<?=$getAdminMenuValue['am_link']?>">
                           <i class="<?=$getAdminMenuValue['am_icon']?>"></i><span><?=$getAdminMenuValue['am_name']?></span>
                           <span class="pull-right-container">
                           <i class="fa fa-angle-left pull-right"></i>
                           </span>
                           </a>
                           <ul class="treeview-menu">
                              <?php foreach ($get_admin_sub_menu as $key => $getAdminSubMenuValue) { ?>
                                 <?php if ($getAdminMenuValue['am_id']==$getAdminSubMenuValue['am_id']){ ?>
                                    <li><a href="<?=base_url('/').$getAdminSubMenuValue['asm_link']?>"><?=$getAdminSubMenuValue['asm_name']?></a></li>
                                 <?php } ?>
