...
<!-- Mirrored from thememinister.com/crm/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jun 2019 09:17:50 GMT -->
<head>
        <meta charset="utf-8">
            ...
            <div class="login-area">
                <div class="panel panel-bd panel-custom">
                    ...
                    <div class="panel-body">
                        <form action="<?=base_url('admin_controller/login')?>" id="loginForm" method="post">
