                                ...
                                <tr>
                                   ...
                                   <td>
                                      ...
                                      <?php } ?>
                                            ...
                                            <a href="<?=base_url('admin_controller/delete_user/').$allUserValue['user_id']?>" class="btn btn-danger btn-sm" style="margin:3px" title="Delete User" onclick="return confirm('You Want To Delete \nUser=<?=$allUserValue['name']?>')" ><i class="fa fa-times-circle"></i></a>
                                   </td>
                                </tr>
                            <?php } ?>
                          <?php } else { ?>
