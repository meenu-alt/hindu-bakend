                     ...
                     <div class="col-xs-4">
                        <div class="inbox-avatar">
                           ...
                           <div class="inbox-avatar-text hidden-xs hidden-sm">
                              <div class="avatar-name">Edit How To use</div>
               ...
               <div class="mailbox-body">
                  <div class="row m-0">
                     <div class="col-xs-12 col-sm-12 col-md-12 p-0 inbox-mail p-20">
                        <?php if (isset($how_to_use)){ ?>
                           <?php foreach ($how_to_use as $key => $how_to_use_value) { ?>
                              <form action="<?=base_url('admin_controller/add_htu/').$how_to_use_value['how_to_use_id']?>" method="post" enctype="multipart/form-data">
                                 <!-- summernote -->
                                 <textarea id="summernote" name="how_to_use_desc"><?=$how_to_use_value['how_to_use_desc']?></textarea>
                                 <div class="btn-group pull-right">
                                    <button type="submit" class="btn btn-add">UPDATE HTU</button>
                                 </div>
                              </form>
                           <?php } ?>                           
                        <?php } else { ?>
